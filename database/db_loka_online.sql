-- --------------------------------------------------------
-- Host:                         103.196.154.3
-- Versi server:                 5.7.44-log - Source distribution
-- OS Server:                    Linux
...
-- membuang struktur untuk table loka-db-jambi.audits
...
-- membuang struktur untuk table loka-db-jambi.barista
...
-- membuang struktur untuk table loka-db-jambi.failed_jobs
...
-- membuang struktur untuk table loka-db-jambi.file
...
-- membuang struktur untuk table loka-db-jambi.fileponds
...
-- membuang struktur untuk table loka-db-jambi.gerobak
...
-- membuang struktur untuk table loka-db-jambi.gerobak_stok
...
-- membuang struktur untuk table loka-db-jambi.histori_lokasi
CREATE TABLE IF NOT EXISTS `histori_lokasi` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=112344 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;

-- Pengeluaran data tidak dipilih.

-- membuang struktur untuk table loka-db-jambi.histori_stok
...
-- membuang struktur untuk table loka-db-jambi.konsumen
...
-- membuang struktur untuk table loka-db-jambi.migrations
...
-- membuang struktur untuk table loka-db-jambi.model_has_permissions
...
-- membuang struktur untuk table loka-db-jambi.model_has_roles
...
-- membuang struktur untuk table loka-db-jambi.oauth_access_tokens
...
-- membuang struktur untuk table loka-db-jambi.oauth_auth_codes
...
-- membuang struktur untuk table loka-db-jambi.oauth_clients
...
-- membuang struktur untuk table loka-db-jambi.oauth_personal_access_clients
...
-- membuang struktur untuk table loka-db-jambi.oauth_refresh_tokens
...
-- membuang struktur untuk table loka-db-jambi.password_resets
...
-- membuang struktur untuk table loka-db-jambi.permissions
...
-- membuang struktur untuk table loka-db-jambi.permission_group
...
-- membuang struktur untuk table loka-db-jambi.personal_access_tokens
...
-- membuang struktur untuk table loka-db-jambi.produk
...
-- membuang struktur untuk table loka-db-jambi.roles
...
-- membuang struktur untuk table loka-db-jambi.role_has_permissions
...
-- membuang struktur untuk table loka-db-jambi.sample
...
-- membuang struktur untuk table loka-db-jambi.settings
...
-- membuang struktur untuk table loka-db-jambi.slider
...
-- membuang struktur untuk table loka-db-jambi.styles
...
-- membuang struktur untuk table loka-db-jambi.transaksi
...
-- membuang struktur untuk table loka-db-jambi.users
